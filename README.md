...
* contribution - (very slow!) calculates the contribution of each contributor to the repository based on the number of commits and the number of survived lines at head.
* contribution3m - (very slow!) same as "contribution" but limited to commits from the last 3 months.
